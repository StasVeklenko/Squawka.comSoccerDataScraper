...
class MySpider(Spider):
    name = 'spain_page_rest_same_file'
    ...
    def parse_match_xml(self, response):
        ...
        squawka_datasheet = spreadsheet("C:/Users/HP10/AppData/Local/Programs/Python/Python35/Lib/site-packages/scrapy/projects/squawka/squawka/excel/squawka_data_5_6_7_8_9.xlsx", "Spain")     
                ...
                for detailed in data[event_name].keys(): #"home_detailed"/"away_detailed"/"home_total"/"away_total"
                    if detailed in ["home_detailed", "away_detailed"]:                        
                        for event in data[event_name][detailed]: #{'mins':'25', 'type': 'Possession', ...}
                            ...
                            print("=========NEXT EVENT==========")
        self.counter += 1
        print("Match number is: "+str(self.counter))
        print("===============")
